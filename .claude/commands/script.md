...
Coaching en pré-préparation Force Athlétique (powerlifting : squat, développé couché,
soulevé de terre). Le compte Instagram fait venir les gens vers la page de candidature
au pré-coaching (lien en bio). Ton : direct, précis, légèrement confrontant, jamais
agressif, jamais corporate. Audience : pratiquants qui veulent progresser sérieusement
...
1. **Menacer une croyance** : retirer l'explication confortable que la cible se donne
   ("c'est pas ta force qui te limite" attaque "je manque de force").
2. **Suggérer une perte** (sans toujours la nommer) : le cerveau réagit plus fort à
   une perte qu'à un gain — temps, kg, séances gâchées, risque de blessure.
3. **Impliquer directement le viewer** : "tu", "si tu fais encore ça", jamais parler du
   sujet en général.
